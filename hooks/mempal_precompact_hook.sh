...
# Map transcript path to being → wing + agent (fork PR #2 per-being
# routing, preserved on top of upstream's security-hardened base).
# Storehouse is NOT auto-routed here — it's reserved for deliberate MCP
# writes (cross-being memories).
AGENT="mempalace"
WING=""
